...
const userEmailsAndCompany = users.map(user => ({
  email: user.email,
  companyName: user.company.name
}));
console.log(userEmailsAndCompany);

// Exercise 2
const ZipCodes5 = users.filter(user => user.address.zipcode.startsWith("5"));
console.log(ZipCodes5);

// Exercise 3

const ModifiedZipCodes5 = users.filter(user => user.address.zipcode.startsWith("5")).map(user => user.id);
console.log(ModifiedZipCodes5);

// Exercise 4

const NamesStartWithC = users.filter(user => user.name.startsWith("C")).map(user => user.name);
console.log(NamesStartWithC);

// Exercise 5
 const DoesAllSouthChristy = users.every(user => user.address.city === "South Christy");
 console.log(DoesAllSouthChristy);
...
const totalCost = cartItems.reduce((total,item) => total + (item.price * item.quantity *(1+ taxRates[item.category])), 0);
